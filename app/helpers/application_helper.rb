module ApplicationHelper
  ...
  def canadian_cities
    options_for_select([['Select a city', ''], ['----CANADA----', 'Canada'],'Kelowna', 'Whistler', 'Vancouver', 'Kamloops',
    ...
    'Iqualit', 'White Horse'], disabled: 'Canada')
  end

  def american_cities
    options_for_select([['-----USA-----', 'USA'],'Seattle', 'Portland', 'San Francisco',
